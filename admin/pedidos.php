  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="../php/insertarproducto.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <input type="text" min="0" name="talla" placeholder="talla" id="talla" class="form-control" required>
        </div>
        <div class="form-group">
        <label for="descripcion">Color</label>
        <input type="text" min="0" name="color" placeholder="color" id="color" class="form-control" required>
        </div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="../php/editarproducto.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <input type="text" min="0" name="talla" placeholder="talla" id="tallaEdit" class="form-control" required>
        </div>
        <div class="form-group">
        <label for="colorEdit">Color</label>
        <input type="text" min="0" name="color" placeholder="color" id="colorEdit" class="form-control" required>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
