...
// Agrega credenciales
MercadoPago\SDK::setAccessToken('TEST-7089720514307735-070919-dfab5f623ebedc8ff054b2e3c097e068-606714915');
...
<body>
<script 
    src="https://www.paypal.com/sdk/js?client-id=AWIzO4RG7R-iWi5e27lkb0jp2NdX9_vco7jhshRGWZiHRHsnzqdADE_q1nj6zhTV5WCIq-hLP-4aE5FR&currency=MXN"> // Replace YOUR_SB_CLIENT_ID with your sandbox client ID
    </script>
  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Elige metodod de pago</h2>
          </div>
          <div class="col-md-7">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_fname" class="text-black">Estado <?php echo $datosEnvio[5];?></label>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_fname" class="text-black">CP <?php echo $datosEnvio[6];?></label>
                  </div>
                </div>
